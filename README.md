...
La V0.7.2 crea automáticamente las columnas de autenticación y la tabla `admin_sessions` al ejecutarse. También se incluye `migrations/0003_admin_auth.sql` como referencia para instalaciones nuevas.
...
## V0.7.2
- Botones PNG y PDF colocados directamente junto al 2.º y 3.º lugar en el ranking público del administrador.
- Botones PNG y PDF también visibles debajo del 2.º y 3.º lugar en el podio público.
- Marca visible v0.7.2 en el portal para confirmar el despliegue.
- HTML/JS/CSS enviados con no-cache para evitar que una versión anterior quede retenida en el navegador.
